...
const SIDE_NAV = [
  ...
  { to: '/dashboard/comercio/perfil', label: 'Mi Perfil', icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg> },
  ...
  useEffect(() => {
    const handler = (e: MouseEvent) => {
      if (perfilRef.current && !perfilRef.current.contains(e.target as Node)) {
        setPanelAbierto(prev => prev === 'perfil' ? null : prev)
      }
    }
    ...
    <div className={styles.shell}>
      ...
      <header className={styles.header}>
        ...
        <div className={styles.headerRight}>
          ...
          <div className={styles.panelAnchor}>
            <button
              className={`${styles.avatarPill} ${panelAbierto === 'perfil' ? styles.avatarPillActivo : ''}`}
              onClick={() => setPanelAbierto(o => o === 'perfil' ? null : 'perfil')}
            >
              ...
              <svg
                ...
                style={{ color: 'var(--fl-ink-faint)', transition: 'transform 0.2s', transform: panelAbierto === 'perfil' ? 'rotate(180deg)' : 'none' }}
              >
            ...
            {panelAbierto === 'perfil' && (
              <div className={styles.perfilDropdown} ref={perfilRef}>
                {/* Header */}
                <div className={styles.perfilDropHeader}>
                  ...
                  <div>
                    ...
                    <span className={styles.perfilDropRol}>Administrador de Rescate</span>
                  </div>
                </div>

                {/* Stats */}
                <div className={styles.perfilDropStats}>
                  <div className={styles.perfilDropStat}>
                    <span className={styles.perfilDropStatNum}>42</span>
                    <span className={styles.perfilDropStatLabel}>Lotes</span>
                  </div>
                  <div className={styles.perfilDropStatDiv}/>
                  <div className={styles.perfilDropStat}>
                    <span className={styles.perfilDropStatNum}>1.2k</span>
                    <span className={styles.perfilDropStatLabel}>kg rescatados</span>
                  </div>
                  <div className={styles.perfilDropStatDiv}/>
                  <div className={styles.perfilDropStat}>
                    <span className={styles.perfilDropStatNum}>328</span>
                    <span className={styles.perfilDropStatLabel}>Reservas</span>
                  </div>
                </div>
                ...
                <nav className={styles.perfilDropMenu}>
                  {[
                    { to: '/dashboard/comercio/perfil', label: 'Mi Perfil', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg> },
                    { to: '/dashboard/comercio/notificaciones', label: 'Notificaciones', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg> },
                    { to: '/dashboard/comercio/configuracion', label: 'Configuración', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg> },
                  ].map(item => (
                    <Link
                      key={item.to}
                      to={item.to}
                      className={styles.perfilDropItem}
